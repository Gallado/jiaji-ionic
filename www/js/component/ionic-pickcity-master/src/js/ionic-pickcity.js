  		...
  		function($rootScope, $ionicModal, $timeout, CityPickerService, $ionicScrollDelegate) {
	  		return {
	          	...
	          	template: '<div class="{{::vm.cssClass}}">'+
                    ...
                    '<input class="item-note" placeholder="城市" ng-model="vm.items" disabled>'+
	  					   	'</a>'+
	  					  '<div>',
                ...
                vm.title = so.title,
        				...
        				vm.isCache = so.isCache === undefined ? true :(Boolean(so.isCache) ? true : false);
	  					...
	  					*/
						$ionicModal.fromTemplateUrl('js/component/ionic-pickcity-master/src/template/ionic.citypicker.html', {
				            'scope': scope,
